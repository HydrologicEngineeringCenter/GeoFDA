Public Class FDA_Structure
	...
	Private _occupancytype As ComputableObjects.OccupancyType
	...
	''' <remarks></remarks>
	Sub New(ByVal name As String, ByVal occtype As ComputableObjects.OccupancyType, ByVal structurevalue As String, ByVal foundationheight As String)
		_name = name
	...
	End Sub
	Sub New(ByVal tabbedline() As String, ByVal headers() As String, ByVal occtype As ComputableObjects.OccupancyType)
		_occupancytype = occtype
		Dim north As Double
	...
	Public ReadOnly Property GetName As String
        ...
        End Get
    End Property
	Public ReadOnly Property GetOccupancyType As ComputableObjects.OccupancyType
		Get
