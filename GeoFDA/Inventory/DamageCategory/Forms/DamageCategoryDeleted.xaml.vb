Public Class DamageCategoryDeleted
	...
	Private _RemainingDamageCategories As List(Of ComputableObjects.DamageCategory)
	Public ReadOnly Property Message As String
        Get
            Return _Message
        End Get
    End Property
	Public Property RemainingDamageCategories As List(Of ComputableObjects.DamageCategory)
		Get
			Return _RemainingDamageCategories
		End Get
		Set(value As List(Of ComputableObjects.DamageCategory))
			_RemainingDamageCategories = value
		End Set
	End Property
	Sub New(ByVal msg As String, ByVal remaindamcats As List(Of ComputableObjects.DamageCategory))
		_Message = msg
