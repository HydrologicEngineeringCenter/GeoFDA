Public Class DamCatRowItem
    ...
    Sub New()
        _indexFactor = 1
    End Sub
    Public Function ToDamCat() As Consequences_Assist.ComputableObjects.DamageCategory
        Return New Consequences_Assist.ComputableObjects.DamageCategory(Name, Description, 365, _indexFactor)
    End Function
