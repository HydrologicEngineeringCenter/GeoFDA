Public Class StructureErrorForm
    Private _SN As StructureInventoryChildTreeNode
    Public ReadOnly Property SICTN As StructureInventoryChildTreeNode
        Get
            Return _SN
        End Get
    End Property
    Sub New(ByRef sn As StructureInventoryChildTreeNode)
        _SN = sn
        InitializeComponent()
    End Sub
