Public Class OccupancyTypeDeleted
	...
	Private _RemainingOcctypes As List(Of ComputableObjects.OccupancyType)
	Public ReadOnly Property Message As String
        Get
            Return _Message
        End Get
    End Property
	Public Property RemainingOccupancyTypes As List(Of ComputableObjects.OccupancyType)
		Get
		...
		End Set
	End Property
	Sub New(ByVal msg As String, ByVal remainocctypes As List(Of ComputableObjects.OccupancyType))
		_Message = msg
