...
Namespace Controls
    Public Class CopyPasteDataGrid
        ...
        Public Sub New()
            '
        End Sub
        Private Sub Me_KeyDown(sender As System.Object, e As System.Windows.Input.KeyEventArgs) Handles Me.KeyDown
            ...
            If TypeOf dep Is DataGridCell Then
                ...
                If IsReadOnly = False Then
                    ...
                    If AllowAddDeleteRows = True Then
                        ...
                        InsertRows.Header = "Insert Row(s)"
        ...
        Private Sub InsertRowItems(sender As Object, e As System.Windows.RoutedEventArgs)
            ...
            Dim p As System.Collections.ObjectModel.ObservableCollection(Of Object) = CType(Me.ItemsSource, System.Collections.ObjectModel.ObservableCollection(Of Object))
            For i As Int32 = 1 To UniqueRows.Count
                p.Insert(InsertAtRow, Activator.CreateInstance(RowType))
            Next
